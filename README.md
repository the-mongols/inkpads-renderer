...
**Developed by The_Mongols at Wargaming's request for the community, built upon the foundation of wows-toolkit.**
...
- [dev/](docs/dev/) - Internal development guides and project roadmap
...
- **Forensic Tactical Rendering**: Generate high-fidelity match reconstructions from `.wowsreplay` files.
  - **Dual-Replay Sync**: Synchronize and merge telemetry from both the "Green" and "Red" team perspectives into a single unified tactical view.
  - **HP & Attrition**: Accurate ship health bars with **Repair Party (recoverable HP)** gray-bar support.
  - **Sabermetrics**: Real-time "Team Advantage" scoring and win-probability breakdown.
  - **Tactical Overlays**: Visualization of consumable active windows (Radar, Hydro, Smoke), turret yaws, and ship movement trails.
- **Discord Integration**: A built-in bot (`inkpads-bot`) for remote rendering via Discord commands.
- **Resource Management**: Browse and extract packed game files and view armor models.
- **Analytics**: Can read replay files and display statistics such as damage dealt, time lived, and potential damage.
- **Community Tools**: Automatically sends builds to shipbuilds.com for competitive statistic gathering.
