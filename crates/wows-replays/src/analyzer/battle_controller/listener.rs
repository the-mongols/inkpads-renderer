...
pub trait BattleControllerState {
    ...
    fn ribbon_history(&self) -> &[super::state::RibbonRecord];

    /// Absolute server timestamp (Unix epoch) from the initial handshake.
    /// Used for synchronizing multiple replay perspectives.
