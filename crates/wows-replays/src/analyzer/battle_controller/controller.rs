...
pub struct BattleController<'res, 'replay, G> {
    ...
    /// Chronological history of earned ribbons for pop-up visualizations.
    ribbon_history: Vec<crate::analyzer::battle_controller::state::RibbonRecord>,
}
    ...
    G: ResourceLoader,
{
    ...
    fn ribbon_history(&self) -> &[crate::analyzer::battle_controller::state::RibbonRecord] {
        &self.ribbon_history
    }
        ...
        match decoded.payload {
            ...
            crate::analyzer::decoder::DecodedPacketPayload::Ribbon(ribbon) => {
                *self.self_ribbons.entry(ribbon).or_insert(0) += 1;
                self.ribbon_history.push(crate::analyzer::battle_controller::state::RibbonRecord {
                    clock: packet.clock,
                    ribbon,
                });
            }
            ...
            crate::analyzer::decoder::DecodedPacketPayload::ServerTimestamp(ts) => {
